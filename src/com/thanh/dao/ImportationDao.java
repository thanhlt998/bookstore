...
public class ImportationDao {
	...
	@SuppressWarnings("unchecked")
	public List<Importation> searchImportationByIdStorageIdListBookIdImportDateOffsetQuantity(String importationId, List<Integer> storageIdList, String bookId, String importDate, int offset, int quantity){
		Criteria criteria = getSession().createCriteria(Importation.class);
		if(!importationId.equals("")) {
			criteria.add(Restrictions.idEq(Integer.parseInt(importationId)));
		}

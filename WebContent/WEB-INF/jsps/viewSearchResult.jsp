	...
	<div class="container my-5 py-5">
		...
		<ul class="pagination justify-content-center">
			<c:choose>
				...
				<c:otherwise>
					<li class="page-item"><a class="page-link"
						href="${pageContext.request.contextPath}/viewSearchResult?searchValue=${searchValue }&page=${page-1}&noPage=${noPage}">Previous</a>
					</li>
				</c:otherwise>
			</c:choose>
			<c:if test="${noPage < 10 }">
				<c:forEach var="i" begin="1" end="${noPage }">
					<c:choose>
						<c:when test="${i != page }">
							<li class="page-item"><a class="page-link"
								href="${pageContext.request.contextPath}/viewSearchResult?searchValue=${searchValue }&page=${i}&noPage=${noPage}">${i
											}</a></li>
						</c:when>
						<c:otherwise>
			...
			<c:if test="${noPage >= 10 }">
				...
				<li class="page-item active"><a class="page-link"
					href="${pageContext.request.contextPath}/viewSearchResult?searchValue=${searchValue }&page=${page}&noPage=${noPage}">page</a></li>
				<li class="page-item"><a class="page-link">...</a></li>
				<li class="page-item"><a class="page-link"
					href="${pageContext.request.contextPath}/viewSearchResult?searchValue=${searchValue }&page=${noPage}&noPage=${noPage}">${noPage
								}</a></li>
			</c:if>
			<c:choose>
				<c:when test="${page != noPage }">
					<li class="page-item"><a class="page-link"
						href="${pageContext.request.contextPath}/viewSearchResult?searchValue=${searchValue }&page=${page+1}&noPage=${noPage}">Next</a></li>
				</c:when>
				<c:otherwise>
